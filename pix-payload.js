 ...
 * Chave: 73988411342 (Alexandra - Equipe da Cozinha Campal)
 */
...
class PixBRCode {
  ...
  static generate({ key, name = 'ALEXANDRA', city = 'ILHEUS', amount = 0, txid = 'CAMPAL' }) {
...
// Configuração padrão da Chef Alexandra
